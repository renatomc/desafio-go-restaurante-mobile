...
import {
  ...
  FinishOrderConfirmationBackground,
  FinishOrderConfirmationText,
} from './styles';
...
const FoodDetails: React.FC = () => {
  ...
  const [
    showFinishOrderConfirmation,
    setShowFinishOrderConfirmation,
  ] = useState(false);
  ...
  useEffect(() => {
    async function loadFavorites(): Promise<void> {
      ...
      setIsFavorite(
        !!response.data.find(
          (favorite: { id: number }) => favorite.id === routeParams.id,
        ),
      );
    }
  ...
  async function handleFinishOrder(): Promise<void> {
    setShowFinishOrderConfirmation(true);
  }
    ...
    <>
      ...
      {showFinishOrderConfirmation && (
        <FinishOrderConfirmation>
          ...
          <Icon size={40} color="#39B100" name="thumbs-up" />
          <FinishOrderConfirmationText>
            Pedido confirmado
          </FinishOrderConfirmationText>
        </FinishOrderConfirmation>
